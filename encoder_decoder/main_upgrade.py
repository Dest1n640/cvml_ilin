...
from train_upgrade import Decoder, Encoder, ImageDataset
...
for mode in mode_arr:
  ...
  encoder_path = Path(f"tmp/encoder_upgrade{mode}.pth")
  decoder_path = Path(f"tmp/decoder_upgrade{mode}.pth")
